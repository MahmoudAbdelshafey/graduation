      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text("Advantages", style: TextStyles.title.bold),
            ],
          ),
        ),
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Top Rated Hospitals", "350 + Hospitals",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("professional doctors", "899 Doctors",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue),
              _categoryCard("High quality Incubators", "2000 + Incubator",
      ...
      delegate: SliverChildListDelegate(
        [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Top Hospitals", style: TextStyles.title.bold),
              IconButton(
                  icon: Icon(
                    Icons.sort,
